    ...
    <div  >
      ...
      <header className=' lg:hidden h-[80px] z-50  duration-300 ease-in-out  p-4  dark:bg-[#1E2139]  bg-[#373b53] flex items-center justify-end   '>
        ...
        <div className='  flex  items-center  '>
          ...
          {colorTheme === "light" ? <motion.img onClick={toggleDarkMode} initial={{ scale: 0.6, rotate: 90 }} animate={{ scale: 1, rotate: 360, transition }} whileTap={{ scale: 0.9, rotate: 15 }} src={sun} className='cursor-pointer h-6'
          />

            : <motion.img className='cursor-pointer h-7' onClick={toggleDarkMode} whileTap={{ scale: 0.9, rotate: 15 }} initial={{ rotate: 45 }} animate={{ rotate: 360, transition }} src={moon} />
          }
